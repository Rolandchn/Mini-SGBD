...
class PageOrientedJoinOperator:
    ...
    def perform_join(self):
        ...
        # Iterate through pages of relation R
        while True:
            ...
            while True:
                ...
                while True:
                    ...
                    print(f"S Page Buffer: {s_buffer.getByte()}")
                    ...
                    while True:
                        ...
                        print(f"Debug: R Record = {r_record.values}")
                        print(f"Debug: S Record = {s_record.values}")
                        print(f"Debug: Combined Record = {combined_record}")
                    ...
                    # Reset S page iterator to ensure we go through all S pages
                    s_page_iterator = PageDirectoryIterator(self.relation2)
